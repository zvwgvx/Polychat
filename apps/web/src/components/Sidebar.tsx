    ...
    <>
      ...
      >
        ...
        <div className="p-4 border-b border-gray-800">
          ...
          <button
            onClick={onNewChat}
            className="w-full flex items-center gap-3 px-3 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-xl transition-all duration-200 group"
          >
        ...
        <div className="flex-1 overflow-y-auto py-2">
          <div className="text-xs text-gray-500 px-4 py-2 font-medium uppercase tracking-wider">
            Chat History
          </div>
          ...
          {sessions.length === 0 ? (
            ...
            <div className="space-y-1 px-2" ref={menuRef}>
